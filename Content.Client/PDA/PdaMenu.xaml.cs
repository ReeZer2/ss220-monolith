...
namespace Content.Client.PDA
{
    ...
    public sealed partial class PdaMenu : PdaWindow
    {
        ...
        private readonly SharedTransformSystem _transform; // Exodus-add-exp-time-to-pda
        ...
        public PdaMenu()
        {
            ...
            _transform = _entitySystem.GetEntitySystem<SharedTransformSystem>(); // Exodus-add-exp-time-to-pda
